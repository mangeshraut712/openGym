...
import { DATE_LOCALES, LANGS } from './i18n.js'
...
describe('Brazilian Portuguese locale', () => {
  ...
  test('makes every inherited pt-PT value an explicit reviewed snapshot', () => {
    ...
    expect(inherited).toHaveLength(395)
    // If this fails, review the changed keys and wording before accepting a new hash. From
    // frontend/: node scripts/pt-br-inheritance-fingerprint.mjs --list
    expect(fingerprint, 'pt-PT inheritance changed; review the inherited pt-BR wording').toBe('ab6e52af38044e20857d60b58bac58e767392e04b7fdba18f28dd4e87405ecf8')
  })
  ...
  test('does not leak European Portuguese UI terms', () => {
    ...
    if ('Unpair' in pt) expect(ptBR.Unpair).toBe('Desvincular')
